...
export const TaskEditorForm = ({ form, onSubmit, disabled, title, description, assignedTo, priority, isUpdating, membersOptions }) => {
    const priorityOptions = getPriorityOptions()

    return <Form form={form} onFinish={onSubmit} disabled={disabled}
        variant='underlined'
        labelCol={{ xs: 24, sm: 8 }}
    ...
    >
        ...
        >
            ...
            >
                ...
                <Item name="assignedTo" initialValue={assignedTo?.userID} label='Assignee' labelAlign='left'>
