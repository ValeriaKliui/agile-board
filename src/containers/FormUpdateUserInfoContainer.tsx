...
export const FormUpdateUserInfoContainer = observer(() => {
    ...
    const formFields = getUserProperties(fulfilledUserProperties, USER_PROPERTIES)
    ...
    return <FormUpdateUserInfo form={form} onFormSubmit={onFormSubmit} isLoading={isLoading} fields={formFields} />
})